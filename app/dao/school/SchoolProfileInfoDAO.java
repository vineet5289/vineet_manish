...
public class SchoolProfileInfoDAO {
  ...
  private Database db;
  @Inject
  private InstituteBoardDAO schoolBoard;
  ...
  public InstituteShiftAndClassTimingInfoForm getSchoolShiftAndClassTimingInfoForm(Long schoolId) throws SQLException {
    ...
    String selectQuery = String.format("SELECT %s, %s, %s, %s, %s, %s, %s, %s FROM %s WHERE %s=? AND %s=?;", Tables.InstituteShiftInfo.shiftName,
        Tables.InstituteShiftInfo.shiftClassStartTime, Tables.InstituteShiftInfo.shiftClassEndTime, Tables.InstituteShiftInfo.shiftWeekStartDay,
        Tables.InstituteShiftInfo.shiftWeekEndDay, Tables.InstituteShiftInfo.shiftStartClassFrom, Tables.InstituteShiftInfo.shiftEndClassTo,
        Tables.InstituteShiftInfo.shiftAttendenceType, Tables.InstituteShiftInfo.table, Tables.InstituteShiftInfo.isActive, Tables.InstituteShiftInfo.instituteId);
    try {
      connection = db.getConnection();
      selectStatement = connection.prepareStatement(selectQuery, ResultSet.TYPE_FORWARD_ONLY);
      selectStatement.setBoolean(1, true);
      ...
      while (resultSet.next()) {
        ...
        shift.setShiftName(resultSet.getString(Tables.InstituteShiftInfo.shiftName));
        shift.setShiftClassStartTime(resultSet.getString(Tables.InstituteShiftInfo.shiftClassStartTime));
        shift.setShiftClassEndTime(resultSet.getString(Tables.InstituteShiftInfo.shiftClassEndTime));
        shift.setShiftWeekStartDay(resultSet.getString(Tables.InstituteShiftInfo.shiftWeekStartDay));
        shift.setShiftWeekEndDay(resultSet.getString(Tables.InstituteShiftInfo.shiftWeekEndDay));
        shift.setShiftStartClassFrom(resultSet.getString(Tables.InstituteShiftInfo.shiftStartClassFrom));
        shift.setShiftEndClassTo(resultSet.getString(Tables.InstituteShiftInfo.shiftEndClassTo));
        shift.setShiftAttendenceType(resultSet.getString(Tables.InstituteShiftInfo.shiftAttendenceType));
        shifts.add(shift);
        numberOfShift++;
      }
  ...
  public InstituteDaoProcessStatus updateSchoolMandInfo(FirstTimeInstituteUpdateForm firstTimeInstituteUpdate, Long instituteId, String userName) throws SQLException {
    ...
    String updateInstituteQ = String.format("UPDATE %s SET %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=?, %s=? WHERE %s=? AND %s=?;",
        ...
        Tables.Institute.officeWeekEndDay, Tables.Institute.classFrom, Tables.Institute.classTo, Tables.Institute.officeStartTime, Tables.Institute.officeEndTime, Tables.Institute.financialStartDay,
        Tables.Institute.financialEndDay, Tables.Institute.financialStartMonth, Tables.Institute.financialEndMonth, Tables.Institute.financialStartYear, Tables.Institute.financialEndYear,
        Tables.Institute.currentFinancialYear, Tables.Institute.financialStartDate, Tables.Institute.financialEndDate, Tables.Institute.boardId, Tables.Institute.type, Tables.Institute.isActive,
        Tables.Institute.id);

    String shiftInsertQ = String.format("INSERT INTO %s (%s, %s, %s, %s, %s, %s, %s, %s, %s) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);", Tables.InstituteShiftInfo.table,
        Tables.InstituteShiftInfo.shiftName, Tables.InstituteShiftInfo.shiftClassStartTime, Tables.InstituteShiftInfo.shiftClassEndTime, Tables.InstituteShiftInfo.shiftWeekStartDay,
        Tables.InstituteShiftInfo.shiftWeekEndDay, Tables.InstituteShiftInfo.shiftStartClassFrom, Tables.InstituteShiftInfo.shiftEndClassTo, Tables.InstituteShiftInfo.shiftAttendenceType,
        Tables.InstituteShiftInfo.instituteId);
    ...
    try {
      ...
      loginPS.setString(5, LoginType.headinstitute.name());
      ...
      updateStmtSchoolMadInfoPS.setString(4, firstTimeInstituteUpdate.getInstituteOfficeWeekStartDay());
      updateStmtSchoolMadInfoPS.setString(5, firstTimeInstituteUpdate.getInstituteOfficeWeekEndDay());
      updateStmtSchoolMadInfoPS.setString(6, firstTimeInstituteUpdate.getInstituteClassFrom());
      updateStmtSchoolMadInfoPS.setString(7, firstTimeInstituteUpdate.getInstituteClassTo());
      ...
      updateStmtSchoolMadInfoPS.setString(17, firstTimeInstituteUpdate.getInstituteFinancialStartDate());
      updateStmtSchoolMadInfoPS.setString(18, firstTimeInstituteUpdate.getInstituteFinancialEndDate());
      updateStmtSchoolMadInfoPS.setLong(19, schoolBoard.getBoardIdGivenAffiliatedTo(firstTimeInstituteUpdate.getInstituteBoard()));
      updateStmtSchoolMadInfoPS.setString(20, firstTimeInstituteUpdate.getInstituteType());
      updateStmtSchoolMadInfoPS.setBoolean(21, true);
      updateStmtSchoolMadInfoPS.setLong(22, instituteId);
      ...
      if (rowSchoolInfoUpdated == 0 || rowLoginUpdated == 0) {
        instituteDaoProcessStatus = InstituteDaoProcessStatus.requestedinstitutednotfound;
        connection.rollback();
      } else {
        connection.commit();
