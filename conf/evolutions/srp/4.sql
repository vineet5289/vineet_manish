...
CREATE TABLE IF NOT EXISTS institute_shift_info (
  ...
  PRIMARY KEY (id),
  KEY FK_institute_shift_info_institute_id (institute_id),
  CONSTRAINT FK_institute_shift_info_institute_id FOREIGN KEY (institute_id) REFERENCES institute (id)
