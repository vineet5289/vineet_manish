...
CREATE TABLE IF NOT EXISTS head_institute (
  ...
  week_start_day varchar(10),
  week_end_day varchar(10),
...
CREATE TABLE IF NOT EXISTS institute (
  ...
  board_id bigint(20) COLLATE utf8_unicode_ci NOT NULL,
  type enum('goverment', 'private', 'internationalschool', 'openschool', 'specialneedschool') DEFAULT 'GOVERMENT' NOT NULL,
