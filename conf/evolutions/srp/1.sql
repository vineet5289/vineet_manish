...
CREATE TABLE IF NOT EXISTS school_registration_request (
  ...
  city varchar(255) COLLATE utf8_unicode_ci DEFAULT NOT NULL,
  state varchar(255) COLLATE utf8_unicode_ci DEFAULT NOT NULL,
  country varchar(255) COLLATE utf8_unicode_ci DEFAULT NOT NULL,
  pin_code varchar(20) COLLATE utf8_unicode_ci DEFAULT NOT NULL,
