...
CREATE TABLE IF NOT EXISTS institute (
  ...
  type enum('govermentinstitute', 'privateinstitute', 'internationalinstitute', 'openinstitute', 'specialneeninstitute') DEFAULT NULL,
  ...
  financial_start_date varchar(50) COLLATE utf8_unicode_ci,
  financial_end_date varchar(50) COLLATE utf8_unicode_ci,
